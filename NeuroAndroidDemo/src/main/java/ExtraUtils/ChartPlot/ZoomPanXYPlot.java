...
public class ZoomPanXYPlot extends XYPlot implements OnTouchListener {
    private static final float MIN_DIST_2_FING = 3f;
    ...
    public ZoomPanXYPlot(Context context, String title, RenderMode mode) {
        super(context, title, mode);
        setZoomEnabled(true); //Default is ZoomEnabled if instantiated programmatically
    }

    public ZoomPanXYPlot(final Context context, final AttributeSet attrs) {
        super(context, attrs);
    ...
    public ZoomPanXYPlot(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public ZoomPanXYPlot(final Context context, final String title) {
        super(context, title);
    }
